...
vars = {}
#vars_start
response = {:status=>200, :headers=>{"server"=>"nginx", "date"=>"Sun, 28 Oct 2012 14:43:41 GMT", "content-type"=>"application/json;charset=utf-8", "content-length"=>"600", "connection"=>"close", "access-control-allow-credentials"=>"true", "cache-control"=>"no-cache, no-store", "access-control-max-age"=>"300"}, :body=>{"amount"=>0, "created"=>1351435421, "currency"=>"usd", "id"=>"tok_0dDjTjpc1QvaTq", "livemode"=>false, "object"=>"token", "used"=>false, "card"=>{"address_city"=>nil, "address_country"=>nil, "address_line1"=>nil, "address_line1_check"=>nil, "address_line2"=>nil, "address_state"=>nil, "address_zip"=>nil, "address_zip_check"=>nil, "country"=>"US", "cvc_check"=>nil, "exp_month"=>5, "exp_year"=>2013, "fingerprint"=>"PvKkd17TxyqPEYGt", "last4"=>"4242", "name"=>nil, "object"=>"card", "type"=>"Visa"}}}
headers  = {:"content-type"=>"application/x-www-form-urlencoded", :authorization=>"Basic YzNqdDdmRzYzZ1JkdTVweEJuWXkxMmZUT0RQVkRuQXE6\\n"}
bodies   = {:"card[number]"=>"4242424242424242", :"card[exp_month]"=>"05", :"card[exp_year]"=>"2013", :"card[cvc]"=>"123", :charges=>nil, :card=>"tok_0dKnOpChiSe6Sp"}
